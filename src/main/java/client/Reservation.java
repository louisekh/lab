 ...
 * 
 */
@WebServiceClient(name = "Reservation", targetNamespace = "http://service/", wsdlLocation = "http://localhost:9091/ReservePlaces?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RESERVATION_QNAME = new QName("http://service/", "Reservation");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9091/ReservePlaces?wsdl");
     ...
     * 
     * @return
     *     returns ReserveHallPlaceService
     */
    @WebEndpoint(name = "ReservationPort")
    public ReserveHallPlaceService getReservationPort() {
        return super.getPort(new QName("http://service/", "ReservationPort"), ReserveHallPlaceService.class);
    }
     ...
     */
    @WebEndpoint(name = "ReservationPort")
    public ReserveHallPlaceService getReservationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "ReservationPort"), ReserveHallPlaceService.class, features);
    }
